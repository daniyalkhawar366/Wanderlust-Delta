...
const { isLoggedIn, isOwner, validateListing, adminAuth } = require("../middleware.js");
...
router
    ...
    .delete(isLoggedIn, isOwner,adminAuth, wrapAsync(listingController.destroyListing));
